...
class _CodeRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dialogDetails = <String>[
      if (code.used && code.usedBy.isNotEmpty) 'استخدمه: ${code.usedBy}',
      if (code.activatedAt != null) 'فُعّل: ${_fmtDate(code.activatedAt!)}',
      if (code.expiry != null) 'ينتهي: ${_fmtDate(code.expiry!)}',
    ];
        ...
        children: [
          ...
          if (dialogDetails.isNotEmpty) ...[
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 13, color: Color(0xFF5D8BAB), fontWeight: FontWeight.w700, height: 1.6),
            ),
          ],
        ],
      ),
