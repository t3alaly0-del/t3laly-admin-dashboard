  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        // Laptop/desktop widths: keep the single-row layout as-is.
        // Narrow mobile widths: put the code on its own row inside the
        // card so it's visible instead of being squeezed out by the
        // badge + action icons.
